...
app.add_middleware(
    ...
    allow_origin_regex=r"https?://(localhost|127\.0\.0\.1|192\.168\.\d+\.\d+|10\.\d+\.\d+\.\d+|172\.\d+\.\d+\.\d+)(:\d+)?|https?://.*\.(serveousercontent\.com|loca\.lt|ngrok-free\.app|ngrok-free\.dev|vercel\.app|netlify\.app|render\.com)",
